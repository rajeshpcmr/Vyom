...
('1', 'Raju', 'raju@gmail.com', '9884627940', 'Raghu', 'raghu@gmail.com', '9790912737', 'Grace to Grace', 'The Brothers', 'Grace Unplugged', 'Everyone', 'Grace', 'Forever', 'Yes', 'Yes', '100', 'No', 'No', '7', 'Yes', 'faith hope and love', '1', 'Array');
...
CREATE TABLE `mail_keys` (
  `mailkey` varchar(100) primary key NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
