...
<head>
    ...
    <title>Vyom | Admin Dashboard</title>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jvectormap/2.0.5/jquery-jvectormap-world-mill-en.min.js"></script>
    <!-- jQuery Knob Chart -->
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-knob/1.2.0/jquery.knob.min.js"></script>
    <!-- DataTables -->
    ...
    <!-- FastClick -->
    <script src="https://cdnjs.cloudflare.com/ajax/libs/fastclick/3.1.0/fastclick.min.js"></script>
    <!-- AdminLTE App -->
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="index.php" class="logo">
            ...
            <span class="logo-lg"><b>Vyom </b>Booking</span>
        </a>
                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body">
                            ...
                            <table id="viewEvent" class="table table-bordered table-hover">
                                ...
                                $sql="SELECT * from event_content,event_status WHERE event_content.eventid=event_status.eventid and event_status.principal=1 ";
