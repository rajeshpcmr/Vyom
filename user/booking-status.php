                        ...
                        <div class="timeline-item">
                            <span class="time"><i class="fa fa-clock-o"></i>
                                ...
                                <?php
                                    ...
                                    // Check if 'submit' key exists in the $count array
                                    if (isset($count['submit'])) {
                                        $time = $count['submit'];
                                        // Use the date function to format the date
                                        $date = date('Y-m-d H:i:s', strtotime($time));
                                        echo $date;
                                    } else {
                                        echo "Submit key not found in the array.";
                                    }
?>
                    ...
                    <li>
                        ...
                        <div class="timeline-item">
                            <span class="time"><i class="fa fa-clock-o"></i>
                                ...
                                $count=mysqli_fetch_array($res4);
                                $time= $count['hod'];
                                $time = "2024-02-15 12:34:56"; // Replace this with your actual time value
